...
AppSrvModel.prototype.genClientModel = function (req, res, modelid, options) {
  ...
  copyValues(rslt, model, [
    'id', 'namespace', 'class', 'layout', 'caption', 'oninit', 'onload', 'onloadimmediate', 'oninsert', 'onupdate', 'oncommit', 'onvalidate', 'onloadstate', 'ongetstate', 'onrowbind', 'getapi', 'ondestroy', 'js', 'hide_system_buttons',
