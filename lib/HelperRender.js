...
exports.reqGet = function (req, res, jsh, ejsname, title, _options, cb) {
  ...
  jsh.RenderTemplate(req, res, options.basetemplate, { title: title, body: rslt, XMenu: options.XMenu, selectedmenu: options.selectedmenu, ejsext: ejsext, modelid: '', req: req, jsh: jsh, params: ejsparams });
