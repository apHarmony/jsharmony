    ...
    if(readonly){
      ...
      if((typename=='varchar')||(typename=='char')||(typename=='binary')){
        ...
        if(typeof length == 'undefined'){
          rslt.control = "textbox_M";
        }
        else {
          var flen = length;
          if(_.includes(typenames, 'binary')||_.includes(typenames, 'varbinary')) flen = flen*2;
          if(flen < 0){ rslt.control = "textarea_M";  rslt.captionclass = "xtextarea_caption"; }
          ...
          else{ rslt.control = "textarea_M"; rslt.captionclass = "xtextarea_caption"; }
        }
      }
    }
  }
