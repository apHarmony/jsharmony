...
//Return whether user has access to any of the permissions in PERM
...
exports.RunEventHandler = function(handlers, cb /*, param1, param2 */){
  if(!cb) cb = function(){ };
  if(!handlers) throw new Error('No handlers found!!!');
  ...
  if(_.isArray(handlers)){
    ...
    var hparams = [cb].concat(params);
    handlers.apply(null, hparams);
  }
}