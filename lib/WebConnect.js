...
***************************/
var xlib = {
  'exec': function(path, params, cb, stdout, stderr, onError){
    var cmd = spawn(path, params);
  ...
  'getStringAsync': function(onStart,onComplete, passchar){
    return function(){ return new Promise(function(resolve,reject){
      ...
      xlib.getString(function(rslt, retry){ if(onComplete(rslt,retry,reject)!==false) return resolve(rslt); },passchar);
    }); };
  },
