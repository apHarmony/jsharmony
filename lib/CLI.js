...
exports.runNodeScript = function(script, params, options, callback){
  ...
  xlib.exec('node',cmd,function(code){ 
...
exports.getPassword = function (cb) { return xlib.getString(cb, '*'); };
...
exports.readParameters = function(config, args){
  ...
  */
  ...
  if(!_.isEmpty(config.parameters)){
    ...
    help_text += '\r\n';
    for(var key in config.parameters){
      var parameter = config.parameters[key];
      help_text += '    --'+key;
  ...
  for(var i=0;i<args.length;i++){
    ...
    if(arg in config.parameters){
      var parameter = config.parameters[arg];
