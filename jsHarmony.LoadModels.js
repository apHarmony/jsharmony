...
exports.ParseEntities = function () {
  ...
  _.forOwn(this.Models, function (model) {
    ...
    var _v_model = [
      ...
      'oninit', 'oncommit', 'onload', 'oninsert', 'onupdate', 'onvalidate', 'onloadstate', 'ongetstate', 'onrowbind', 'onrowunbind', 'ondestroy', 'getapi',
    ...
    var _v_controlparams = [
      ...
      'image', 'thumbnails', 'expand_all', 'expand_to_selected', 'onmove', 'ondrop', 'drag_anchor_settings', 'item_context_menu', 'insert_link', 'grid_save_before_update', "update_when_blank", "htmlarea_config"
    ];
